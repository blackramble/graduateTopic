...
export class Orderst2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            sqldata: null
    ...
    // 呼叫後端call API
    handleClick() {
        fetch('http://localhost:8000/admin/orderlist/mainlist/status2', { method: "GET" })
            .then(res => res.json())
            .then(data => {
            ...
            <div id='memberBody' className='col-12'>
                ...
                <div className='row'>
                    ...
                    <div className=" btn-group btn-group-toggle m-3" data-toggle="buttons">
                        ...
                        </label><label className="btn statusBtnsact">
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-footer">
                                {/* <button type="button" className="btn cancelBtn" data-dismiss="modal" >取消</button> */}
